...
{ /**
	...
	public void create_main_items()
	{
		...
		date1.setToolTipText("dd-mm-yyy");
		tborder.setTitleFont(new Font("TimesNewRoman",Font.BOLD,18));				//CHANGING THE FONT STYLE
		...
		title.setFont(new Font("Countryside",Font.BOLD,40));
